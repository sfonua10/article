...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      console.log(this.state.articles); // console.log(this.state.images);
      ...
      if (!isLoaded) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("article", {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Image__WEBPACK_IMPORTED_MODULE_2__["default"], {
            ...
            thumbnailUrl: article.images.map(function (j) {
              return j.thumbnailUrl;
            }),
            i_title: article.images.title,
            i_description: article.images.description,
            __source: {
              fileName: _jsxFileName,
              lineNumber: 51
            },
...
//# sourceMappingURL=index.js.c873429878f4b4a5eccd.hot-update.js.map