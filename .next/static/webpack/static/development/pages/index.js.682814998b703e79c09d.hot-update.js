...
function (_Component) {
  ...
  function Image() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      i_title: _this.props.i_title // i_description: this.props.i_description
...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    key: "render",
    value: function render() {
      console.log("articles", this.state.articles.images); // console.log(this.state.images);
...
//# sourceMappingURL=index.js.682814998b703e79c09d.hot-update.js.map