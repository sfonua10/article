...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      // console.log("articles", this.state.articles.map(url => url.url));
      // console.log(this.state.images);
      // console.log(this.state.content);
      console.log("image info", this.state.articles.images);
      ...
      if (!isLoaded) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("article", {
          ...
          __self: this
        }, "testing 1 article"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Image__WEBPACK_IMPORTED_MODULE_2__["default"], {
          title: this.state.articles.title,
          imageInfo: this.state.articles.images,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 80
          },
...
//# sourceMappingURL=index.js.e1a8e577354a644f3102.hot-update.js.map